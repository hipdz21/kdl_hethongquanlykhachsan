...
public class ReportController {
    ...
    public List<Object[]> getTotalRevenueRoomTypeBookingInMonth(@RequestParam("month") int month, @RequestParam("year") int year) {
        try {
            return billBookingRepository.getTotalRevenueRoomTypeBookingInMonth(month, year);
        } catch (Exception e) {
            System.out.println(e);
        }
        return null;
    ...
    public List<Object[]> getNumberRoomTypeBookingInMonth(@RequestParam("month") int month, @RequestParam("year") int year) {
        try {
            return billBookingRepository.getNumberRoomTypeBookingInMonth(month, year);
        } catch (Exception e) {
            System.out.println(e);
        }
        return null;
    ...
    public List<Object[]> getNumberServiceInMonth(@RequestParam("month") int month, @RequestParam("year") int year) {
        try {
            return billServiceRepository.getNumberServiceInMonth(month, year);
        } catch (Exception e) {
            System.out.println(e);
        }
        return null;
    ...
    public List<Object[]> getTotalRevenueServiceInMonth(@RequestParam("month") int month, @RequestParam("year") int year) {
        try {
            return billServiceRepository.getTotalRevenueServiceInMonth(month, year);
        } catch (Exception e) {
            System.out.println(e);
        }
        return null;
    ...
    public List<Object[]> getEvenueClientByGroupAge(@RequestParam("month") int month, @RequestParam("year") int year) {
        try {
            return userRepository.getEvenueClientByGroupAge(month, year);
        } catch (Exception e) {
            System.out.println(e);
        }
        return null;
