...
public class RevenueController {
    ...
    public Double getRevennueByMonth(@RequestParam("month") int month) {
        try {
            double revenueBooking = billBookingRepository.getTotalRevenueForMonth(month, 2023);
    ...
    public List<Object[]> getTotalRevenueByDayInMonth(@RequestParam("month") int month, @RequestParam("year") int year) {
        try {
            return billBookingRepository.getTotalRevenueByDayInMonth(month, year);
        } catch (Exception e) {
            System.out.println(e);
        }
        return null;
    ...
    public List<Object[]> getTotalRevenueBookingAndUseServiceInMonth(@RequestParam("month") int month, @RequestParam("year") int year) {
        try {
            return billBookingRepository.getTotalRevenueBookingAndUseServiceInMonth(month, year);
        } catch (Exception e) {
            System.out.println(e);
        }
        return null;
